...
// gql parser function parses plain string as query
...
// we passed client as prop from App component
// when you return with <Query> component, apollo injects props into the components render prop function
